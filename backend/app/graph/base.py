...
class GraphStore(Protocol):
    ...
    # Removal of individual nodes, with their edges. `clear()` is all-or-
    # nothing, which is no use to a caller that has to take back exactly what
    # it added - the eval harness reverting the disputes its own cases raised.
